...
--
-- Host: localhost:3306
-- Generation Time: Oct 08, 2025 at 10:22 PM
...
(1, 'maryelle', '$2y$10$IKImRich3JaRfGYugjsCoeoMLuhjm4/p4EvGCgfxqOhL7Gx8S9B.2', 1, 'active', '2025-10-08 19:38:36', '2025-09-23 22:58:50', '2025-10-08 19:38:36'),
(14, 'christopherporter543', '$2y$10$m7lsVOAzxjK7wCtXl45PNeGhBfzYtGGxdzBVyRKT/wMswC0Ssat6K', 4, 'active', '2025-10-07 21:12:13', '2025-10-06 08:46:36', '2025-10-07 21:12:13'),
...
--
ALTER TABLE `employee_allowance`
  MODIFY `employee_allowance_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;

--
-- AUTO_INCREMENT for table `employee_deduction`
--
ALTER TABLE `employee_deduction`
  MODIFY `employee_deduction_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=86;
...
--
ALTER TABLE `payroll`
  MODIFY `payroll_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;

--
-- AUTO_INCREMENT for table `payroll_allowance`
--
ALTER TABLE `payroll_allowance`
  MODIFY `payroll_allowance_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=72;

--
-- AUTO_INCREMENT for table `payroll_deduction`
--
ALTER TABLE `payroll_deduction`
  MODIFY `payroll_deduction_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=88;
...
--
ALTER TABLE `payroll_allowance`
  ADD CONSTRAINT `payroll_allowance_ibfk_1` FOREIGN KEY (`payroll_id`) REFERENCES `payroll` (`payroll_id`) ON DELETE CASCADE ON UPDATE RESTRICT,
  ADD CONSTRAINT `payroll_allowance_ibfk_2` FOREIGN KEY (`allowance_id`) REFERENCES `allowance` (`allowance_id`) ON DELETE CASCADE ON UPDATE RESTRICT;

--
-- Constraints for table `payroll_deduction`
--
ALTER TABLE `payroll_deduction`
  ADD CONSTRAINT `payroll_deduction_ibfk_1` FOREIGN KEY (`payroll_id`) REFERENCES `payroll` (`payroll_id`) ON DELETE CASCADE ON UPDATE RESTRICT,
  ADD CONSTRAINT `payroll_deduction_ibfk_2` FOREIGN KEY (`deduction_type_id`) REFERENCES `deduction_type` (`deduction_type_id`) ON DELETE CASCADE ON UPDATE RESTRICT;
