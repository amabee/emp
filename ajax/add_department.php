...
// Only admin and supervisor can add departments
...
try {
    ...
    $result = $controller->addDepartment($data);
    
    // Log the action if successful
    if ($result['success']) {
        $logger = new SystemLogger();
        $logger->logOrganizationalAction($_SESSION['user_id'], 'created', 'department', $data['department_name']);
    }
